import styles from "./AddedNew.module.css"
const AddedNew = () => {
  return (
        ...
        <div className={styles.leftSection}>
          ...
          <div className={styles.socialIcons}>
              ...
              >
                ...
                >
                  <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1811_2638)">
                      ...
                      <path d="M31.3637 15.8694C31.3637 15.8694 28.8183 14 25 14C22.4547 14 18 14 18 18.8889C18 25 32 25 32 31.1115C32 36 27.5453 36 25 36C21.182 36 18.6367 34.1306 18.6367 34.1306" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
                    </g>
                    <defs>
            ...
            <div className={styles.icon}>
              <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_1815_2641)">
          ...
          <div className={styles.bottonClipArt}>
            <svg className={styles.svg} xmlns="http://www.w3.org/2000/svg" width="100" height="87" viewBox="0 0 100 87" fill="none">
              <path d="M98.3548 59.8982C93.8987 50.686 79.931 34.7703 59.7097 44.8051C34.433 57.3487 9.59468 34.7809 8.04079 25.7901" stroke="white" stroke-width="2" />
              <path d="M17.9098 28.4569L7.68337 24.4833L2.68991 34.4695" stroke="white" stroke-width="2.61617" />
            </svg>
